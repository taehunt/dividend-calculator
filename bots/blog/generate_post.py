...
def footer_block(tool_path: str, *, lang: str) -> str:
    ...
    if lang == "ko":
        return "\n".join(
            [
                ...
                "",
                "이 글은 AI 보조로 작성되었습니다. 공개 전 편집 검토가 필요하며 자동 검사만으로 발행할 수 없습니다.",
                "",
    ...
    return "\n".join(
        [
            ...
            "",
            "This article was drafted with AI assistance. It requires editorial review before public publication; automated checks alone cannot publish it.",
            "",
...
def write_post(
    ...
    frontmatter_lines = [
        ...
        'generationMethod: "AI-assisted; requires editorial review before publication"',
        "draft: true",
